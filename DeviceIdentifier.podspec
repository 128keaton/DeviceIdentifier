#
#  Be sure to run `pod spec lint DeviceIdentifier.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Keaton Burleson"
  # spec.authors            = { "Keaton Burleson" => "keaton.burleson@me.com" }
  # spec.social_media_url   = "https://twitter.com/Keaton Burleson"
  ...
  spec.source       = { :git => "https://github.com/128keaton/DeviceIdentifier.git", :tag => "#{spec.version}" }
